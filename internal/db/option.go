...
// WithMaxIdleConnections specifies and optional max idle connections for the
// database.
...
// WithConnMaxIdleTimeDuration specifies and optional connection max idle time
// for the database.
